    ...
    <>
      ...
      <div className="page">
        <section className="hero">
          ...
          <div className="ctaRow">
            <a className="btn primary" href="https://wa.me/34606657631?text=Hola%2C%20quiero%20informaci%C3%B3n%20sobre%20web%2C%20bot%20o%20automatizaci%C3%B3n" target="_blank" rel="noreferrer">Calcular presupuesto</a>
            <a className="btn ghost" href="#precios">Ver precios</a>
          </div>
        </section>

        <article className="launchOffer" id="oferta">
          <span className="offerRibbon">PROMO</span>
          <h3>Obtén un 20% de descuento</h3>
          <p>
            Promoción de bienvenida para nuevos clientes en su primer proyecto.
          </p>
          <div className="offerPoints">
            <span>
              ...
              Válido para nuevas altas
            </span>
            <span>
              <svg viewBox="0 0 24 24" aria-hidden="true">
                <path d="m5 12 4 4 10-10" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              Aplicable a web, bot o automatización
            </span>
          </div>
          <a className="btn offerCta" href="https://wa.me/34606657631?text=Hola%2C%20quiero%20activar%20la%20oferta%20de%20nuevos%20clientes" target="_blank" rel="noreferrer">Activar oferta</a>
        </article>
          ...
          <article className="guarantee">
            ...
            <div className="guaranteeList">
              <p className="guaranteeItem">
                <span className="guaranteeIcon" aria-hidden="true">
                  <svg viewBox="0 0 24 24"><path d="m5 12 4 4 10-10" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                </span>
      ...
      <footer className="footer">
        ...
        <div className="footerMeta">
          <p>Atención: de lunes a viernes, 09:00 a 18:00</p>
          <p>© {new Date().getFullYear()} Kopa Studio</p>
        </div>
      </footer>
    </>
  )
