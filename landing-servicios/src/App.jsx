  ...
  return (
    <>
      ...
      <section className="hero">
        ...
        {/* Panel derecho — visual de servicios */}
        <div className="heroVisual" aria-hidden="true">
          {/* Card grande — Web */}
          <div className="heroCard">
            <span className="heroCardIcon">
              <svg viewBox="0 0 24 24" fill="none"><rect x="4" y="6" width="16" height="12" rx="2" stroke="currentColor" strokeWidth="1.8"/><path d="M8 10h8M8 14h5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>
            </span>
            <div>
              <p className="heroCardLabel">Servicio principal</p>
              <p className="heroCardTitle">Web de captación</p>
          ...
          <div className="heroCard">
            <div className="heroCardIcon">
              <svg viewBox="0 0 24 24" fill="none"><path d="M5 12a7 7 0 1 1 2.1 5L5 19l2.1-2A6.9 6.9 0 0 1 5 12Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round"/><path d="M9 12h6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>
            </div>
            <p className="heroCardLabel">Bot IA</p>
            <p className="heroCardTitle">Atención 24/7</p>
          ...
          <div className="heroCard">
            <div className="heroCardIcon">
              <svg viewBox="0 0 24 24" fill="none"><path d="M8 8h8v8H8z" stroke="currentColor" strokeWidth="1.8"/><path d="M12 4v3M12 17v3M4 12h3M17 12h3" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"/></svg>
            </div>
